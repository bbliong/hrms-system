			...
			<ul class="sidebar-nav">
				...
				<li><a href="#">&nbsp  <span class="glyphicon glyphicon-briefcase"></span>&nbsp  Departement</a></li>
				...
				<li><a data-toggle="modal" data-target="#contact">&nbsp <span class="glyphicon glyphicon-cog"></span>&nbsp User Setting</a>
			</ul>
		</div>